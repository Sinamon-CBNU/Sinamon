...
//import practice_user_info.db_connection;
...
public class SinamonApp {
	...
	public Object curr_user[] = {"", "", "", "", "", ""};		//현재 로그인하고 있는 유저의 정보 담을 배열
	public Object[][] food_board_data = new Object[10][5];		//한 행에 5칸 있는 Object형 배열 선언
	public Object[][] nec_board_data = new Object[10][5];		//한 행에 5칸 있는 Object형 배열 선언
	...
	private void initialize() {
		...
		ImagePanel mypagePanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\mypage.png").getImage());
		frame.getContentPane().add(mypagePanel);
		ImagePanel foodPanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\board.png").getImage());
		frame.getContentPane().add(foodPanel);
		ImagePanel necPanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\board.png").getImage());
		frame.getContentPane().add(necPanel);
		ImagePanel choicePanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\choice.png").getImage());
		frame.getContentPane().add(choicePanel);
		ImagePanel joinPanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\join.png").getImage());
		frame.getContentPane().add(joinPanel);
		ImagePanel loginPanel = new ImagePanel(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\login.png").getImage());
		...
		MPbackBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\back_btn.PNG"));
		...
		//예시
		//Object[][] nec_board_data = new Object[10][5];		//한 행에 5칸 있는 Object형 배열 선언
		...
		searchBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\search_btn.PNG"));
		...
		myBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\my_btn.PNG"));
		...
		recBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\rec_btn.png"));
		...
		writeBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\write_btn.PNG"));
		...
		boardBackBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\back_btn.PNG"));
		...
		//예시
		//Object[][] food_board_data = new Object[10][5];		//한 행에 5칸 있는 Object형 배열 선언
		...
		writeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//자, 게시판에 글을 썼어, 데이터베이스에 들어가지? 그러면 게시물 등록 누르면 자동으로 화면 갱신돼야되는데, 바로 갱신 안됨. 위에 화면 띄우는 그 부분 다시 실행해야될거
				//같은데, 좋은 생각 있으면 해바
		...
		foodBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\Ch_food.PNG"));
		...
		necBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\Ch_nec.PNG"));
		...
		JComboBox comboBox = new JComboBox(place);		//사는 곳
		...
		enrollBtn.addActionListener(new ActionListener(){	
			...
			public void actionPerformed(ActionEvent e) {	//등록하기 버튼을 눌렀을 때의 동작
				try {
					...
					//input_user_info(String name, String nickname, String id, String pwd, String home)
		...
		enrollBtn.setPressedIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\enroll_click_btn.PNG"));
		joinPanel.add(enrollBtn);
		enrollBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\enroll_btn.PNG"));
		...
		backBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\back_btn.PNG"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(connection.login(idString, pwdString)) {				//해당되는 아이디와 패스워드 일치하면 true 반환
					...
					curr_user = connection.return_user_info(idString);	//현재 로그인중인 회원 정보 
					 		//임의로 출력한 부분 -> 회원정보임
					for(int i=0; i<6; i++) {
						System.out.println(curr_user[i].getClass().getSimpleName());
					}
		...
		loginBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\login_btn.PNG"));
		loginBtn.setPressedIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\login_click_btn.PNG"));
		...
		joinBtn.setIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\join_btn.PNG"));
		joinBtn.setPressedIcon(new ImageIcon("C:\\Users\\kkssh\\Desktop\\eclipse-workspace\\Sinamon_DB\\Image\\join_click_btn.PNG"));
