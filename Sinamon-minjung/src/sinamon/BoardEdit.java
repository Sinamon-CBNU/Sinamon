...
public class BoardEdit {
	 ...
	 */
	public BoardEdit(db_connection connection) {
	...
	private void initialize(db_connection connection) {
		...
		editBtn.addActionListener(new ActionListener() { 
            ...
            public void actionPerformed(ActionEvent e) {
            	//modify_board(String location, String time, String title) 
            	connection.modify_board("7", chTimeField.getText(), chTitleArea.getText());
